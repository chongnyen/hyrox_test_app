...
def save_lead_to_sheet(name, whatsapp, struggle):
    try:
        sheet = init_gsheets()
        if sheet:
...
NEON, CYAN, RED, DARK_BG, CARD_BG, GRID_COLOR = "#FF6B35", "#00F0FF", "#FF4B4B", "#0E1117", "#1A1C23", "#2D2D2D"
...
<div style="text-align: center; padding: 30px; color: rgba(255,255,255,0.6);">
    ...
    <p style="font-size: 0.75em; margin-top: 15px; color: rgba(255,255,255,0.4);">
